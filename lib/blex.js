...
* @Last Modified time: 2017-08-22 09:37:34
*/
...
// what = lexer("given i like what i see\nthen i should be on the next line\nfeature: this is a feature", "oh hi");
// var t = what.next()
// while (!t.done) {
// 	if (t.value.type != "NEWLINE")
// 	console.log(t.value.type, t.value.data);
// 	t = what.next()
// }
